...
<div class="container py-4">
    ...
    <div class="debug-info" style="background:#f4f6f9; padding: 0px; margin: 0px 0; border-radius: 0px; max-height: 0px; overflow-y: auto;"></div>
    <?php if (isset($error)): ?>
    ...
    <form method="POST" class="mt-4">
        ...
        <div class="mt-3">
            ...
            <button type="submit" class="btn btn-primary">
                <i class="fas fa-upload"></i> Importar Apostas
            </button>
        </div>
    </form>
</div>
